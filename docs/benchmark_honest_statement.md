...
## 版本：v1.3.1 | 测试日期：2026-08-03 | 本文档更新：2026-08-03
...
> **数据来源说明**：以上数据基于 v1.3.1 代码于 2026-08-03 重新运行获得，测试环境：Windows 10 / Python 3.12.0 / 6 CPU 核心。测试时禁用观察模式（`enable_observing_mode=False`），直接在保护模式下运行，以测试系统的真实检测能力。
