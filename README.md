...
| 平台 | 安装包 | 说明 |
|------|--------|------|
| Windows x64 | `XuanDun_1.3.5-beta_x64-setup.exe` | NSIS 安装程序 |
| macOS (Apple Silicon) | `XuanDun_1.3.5-beta_aarch64.dmg` | Apple Silicon 原生；Intel 版待支持 |
| Linux x64 | `XuanDun_1.3.5-beta_amd64.AppImage` | 便携版 |
| Linux x64 | `XuanDun_1.3.5-beta_amd64.deb` | Debian/Ubuntu 包 |
