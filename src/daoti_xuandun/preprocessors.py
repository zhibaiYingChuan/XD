...
_CHINESE_HARMFUL_CONTENT_PRECISE: Tuple[str, ...] = (
    ...
    "制作武气", "制造武气", "制作武器", "制造武器",
    # 交易类动作（买/卖/求购）+ 危险对象：单独「买」字是生活常用词，必须与危险对象组合避免误拦
    "购买爆炸物", "购买炸弹", "购买炸药", "购买武器", "购买毒品", "购买枪支", "购买弹药", "购买雷管", "购买引信",
    "买爆炸物", "买炸弹", "买炸药", "买武器", "买毒品", "买枪支", "买弹药", "买雷管", "买引信",
    "买炸要", "买炸单", "买炸蛋", "买诈药", "买毒平", "买毒pin",
    "卖炸药", "卖武器", "卖毒品", "卖枪支", "卖弹药", "出售炸药", "出售武器", "出售毒品", "出售枪支", "出售弹药",
    "求购炸药", "求购武器", "求购毒品", "求购枪支", "求购弹药", "购买危险品", "购买危险物品", "购买管制刀具", "买管制刀具",
    "实施诈骗", "进行诈骗", "诈骗他人", "如何诈骗",
    "实施暴力", "进行暴力", "暴力行为", "暴力解决",
    "制作毒品", "制造毒品", "毒品制造", "制作色情",
    "制作毒平", "制造毒平", "制作毒pin", "制造毒pin",
    "合成毒pin", "配制毒pin", "合成毒平", "配制毒平",
    "合成炸药", "合成炸弹", "合成爆炸物", "配制炸药", "配制炸弹", "配制爆炸物",
    "制造色情", "色情书刊", "色情内容", "色情小说",
